...
public class seleniumRepository extends BasePage {
	...
	public WebDriver crossBrowserTesting(String browserName) {
		...
		try {
			if (browserName.equalsIgnoreCase("chrome")) {
				...
				System.setProperty("webdriver.geko.driver", "src\\test\\resources\\Browsers\\geckodriver.exe");
  ...
  int [] num = {1,2,3,4,5,6,7};
   ...
   System.out.println("This is the array value\t"+num[6]);
